    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Reserva Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="responsavel" value="<?php echo $this->input->post('responsavel'); ?>" class="form-control" id="responsavel" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dt_solicitacao" value="<?php echo $this->input->post('dt_solicitacao'); ?>" class="form-control" id="dt_solicitacao" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="dt_aprovacao" class="control-label">Dt Aprovacao</label>
						<div class="form-group">
							<input type="text" name="dt_aprovacao" value="<?php echo $this->input->post('dt_aprovacao'); ?>" class="form-control" id="dt_aprovacao" />
						</div>
					</div>
					<div class="col-md-6">
